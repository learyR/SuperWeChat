...
//				.commit();
    ...
    private void checkedLogined(Bundle savedInstanceState) {
...
//        adapter.addFragment(new ContactListFragment(), getString(R.string.contacts));
        ...
        mTitlePopup = new TitlePopup(MainActivity.this, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    public void onClickTitlePopup() {
        mTitlePopup.show(findViewById(R.id.layout_head));
...
//		}
    ...
    protected void onNewIntent(Intent intent) {
        ...
        boolean isBack = getIntent().getBooleanExtra(I.ACTION_BACK_CONVERSION, false);
